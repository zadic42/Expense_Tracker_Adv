  ...
  return (
    <div className="min-h-screen bg-white p-6">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-slate-800 mb-2">Budget Management</h1>
          <p className="text-slate-600">Set and track your spending budgets</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-2xl shadow-lg p-6 border-l-4 border-blue-500">
            <div className="flex items-center justify-between mb-2">
              <span className="text-slate-600 text-sm font-medium">Total Budgets</span>
              <DollarSign className="w-5 h-5 text-blue-500" />
            </div>
            <p className="text-3xl font-bold text-slate-800">{budgets.length}</p>
          </div>

          <div className="bg-white rounded-2xl shadow-lg p-6 border-l-4 border-green-500">
            <div className="flex items-center justify-between mb-2">
              <span className="text-slate-600 text-sm font-medium">Total Budget</span>
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          {fetchLoading ? (
            ...
            <div className="divide-y divide-slate-200">
              {budgets.map((budget) => (
                <div key={budget._id} className="p-6 hover:bg-slate-50 transition-colors">
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex gap-2 ml-4">
                      <button
                        ...
                        className="p-2 text-slate-600 hover:bg-blue-50 rounded-lg transition-colors"
                      >
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-slate-800"
                    >
